...
let g:rainbow_conf = {'ctermfgs': ['red', 'lightmagenta', 'lightyellow', 'lightgreen', 'lightblue', 'cyan', 'lightred', 'magenta', 'yellow', 'green', 'blue', 'lightcyan']}
